                        ...
                        auto runAlignmentKernels = [&](auto& d_scores, ReferenceIdT* d_overflow_positions, int* d_overflow_number){
                            ...
                            for(int lp = plan.h_partitionIds.size() - 1; lp >= 0; lp--){
                                ...
                                if(kernelTypeConfig.singlePassType == KernelType::Half2){
                                    ...
                                    if (partId == 0){call_NW_local_affine_single_pass_half2<sh2bs, 2, 24>(subMatrixType, inputChars, d_scores, inputOffsets , inputLengths, d_selectedPositions, numSeq, d_overflow_positions, d_overflow_number, 0, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 1){call_NW_local_affine_single_pass_half2<sh2bs, 4, 16>(subMatrixType, inputChars, d_scores, inputOffsets , inputLengths, d_selectedPositions, numSeq, d_overflow_positions, d_overflow_number, 0, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 2){call_NW_local_affine_single_pass_half2<sh2bs, 8, 10>(subMatrixType, inputChars, d_scores, inputOffsets , inputLengths, d_selectedPositions, numSeq, d_overflow_positions, d_overflow_number, 0, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 3){call_NW_local_affine_single_pass_half2<sh2bs, 8, 12>(subMatrixType, inputChars, d_scores, inputOffsets , inputLengths, d_selectedPositions, numSeq, d_overflow_positions, d_overflow_number, 0, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 4){call_NW_local_affine_single_pass_half2<sh2bs, 8, 14>(subMatrixType, inputChars, d_scores, inputOffsets , inputLengths, d_selectedPositions, numSeq, d_overflow_positions, d_overflow_number, 0, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 5){call_NW_local_affine_single_pass_half2<sh2bs, 8, 16>(subMatrixType, inputChars, d_scores, inputOffsets , inputLengths, d_selectedPositions, numSeq, d_overflow_positions, d_overflow_number, 0, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 6){call_NW_local_affine_single_pass_half2<sh2bs, 8, 18>(subMatrixType, inputChars, d_scores, inputOffsets , inputLengths, d_selectedPositions, numSeq, d_overflow_positions, d_overflow_number, 0, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 7){call_NW_local_affine_single_pass_half2<sh2bs, 8, 20>(subMatrixType, inputChars, d_scores, inputOffsets , inputLengths, d_selectedPositions, numSeq, d_overflow_positions, d_overflow_number, 0, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 8){call_NW_local_affine_single_pass_half2<sh2bs, 8, 22>(subMatrixType, inputChars, d_scores, inputOffsets , inputLengths, d_selectedPositions, numSeq, d_overflow_positions, d_overflow_number, 0, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 9){call_NW_local_affine_single_pass_half2<sh2bs, 8, 24>(subMatrixType, inputChars, d_scores, inputOffsets , inputLengths, d_selectedPositions, numSeq, d_overflow_positions, d_overflow_number, 0, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 10){call_NW_local_affine_single_pass_half2<sh2bs, 8, 26>(subMatrixType, inputChars, d_scores, inputOffsets , inputLengths, d_selectedPositions, numSeq, d_overflow_positions, d_overflow_number, 0, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 11){call_NW_local_affine_single_pass_half2<sh2bs, 8, 28>(subMatrixType, inputChars, d_scores, inputOffsets , inputLengths, d_selectedPositions, numSeq, d_overflow_positions, d_overflow_number, 0, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 12){call_NW_local_affine_single_pass_half2<sh2bs, 8, 30>(subMatrixType, inputChars, d_scores, inputOffsets , inputLengths, d_selectedPositions, numSeq, d_overflow_positions, d_overflow_number, 0, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 13){call_NW_local_affine_single_pass_half2<sh2bs, 8, 32>(subMatrixType, inputChars, d_scores, inputOffsets , inputLengths, d_selectedPositions, numSeq, d_overflow_positions, d_overflow_number, 1, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 14){call_NW_local_affine_single_pass_half2<sh2bs, 16, 18>(subMatrixType, inputChars, d_scores, inputOffsets , inputLengths, d_selectedPositions, numSeq, d_overflow_positions, d_overflow_number, 1, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 15){call_NW_local_affine_single_pass_half2<sh2bs, 16, 20>(subMatrixType, inputChars, d_scores, inputOffsets , inputLengths, d_selectedPositions, numSeq, d_overflow_positions, d_overflow_number, 1, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 16){call_NW_local_affine_single_pass_half2<sh2bs, 16, 22>(subMatrixType, inputChars, d_scores, inputOffsets , inputLengths, d_selectedPositions, numSeq, d_overflow_positions, d_overflow_number, 1, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 17){call_NW_local_affine_single_pass_half2<sh2bs, 16, 24>(subMatrixType, inputChars, d_scores, inputOffsets , inputLengths, d_selectedPositions, numSeq, d_overflow_positions, d_overflow_number, 1, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 18){call_NW_local_affine_single_pass_half2<sh2bs, 16, 26>(subMatrixType, inputChars, d_scores, inputOffsets , inputLengths, d_selectedPositions, numSeq, d_overflow_positions, d_overflow_number, 1, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 19){call_NW_local_affine_single_pass_half2<sh2bs, 16, 28>(subMatrixType, inputChars, d_scores, inputOffsets , inputLengths, d_selectedPositions, numSeq, d_overflow_positions, d_overflow_number, 1, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 20){call_NW_local_affine_single_pass_half2<sh2bs, 16, 30>(subMatrixType, inputChars, d_scores, inputOffsets , inputLengths, d_selectedPositions, numSeq, d_overflow_positions, d_overflow_number, 1, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 21){call_NW_local_affine_single_pass_half2<sh2bs, 16, 32>(subMatrixType, inputChars, d_scores, inputOffsets , inputLengths, d_selectedPositions, numSeq, d_overflow_positions, d_overflow_number, 1, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 22){call_NW_local_affine_single_pass_half2<sh2bs, 32, 18>(subMatrixType, inputChars, d_scores, inputOffsets , inputLengths, d_selectedPositions, numSeq, d_overflow_positions, d_overflow_number, 1, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 23){call_NW_local_affine_single_pass_half2<sh2bs, 32, 20>(subMatrixType, inputChars, d_scores, inputOffsets , inputLengths, d_selectedPositions, numSeq, d_overflow_positions, d_overflow_number, 1, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 24){call_NW_local_affine_single_pass_half2<sh2bs, 32, 22>(subMatrixType, inputChars, d_scores, inputOffsets , inputLengths, d_selectedPositions, numSeq, d_overflow_positions, d_overflow_number, 1, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 25){call_NW_local_affine_single_pass_half2<sh2bs, 32, 24>(subMatrixType, inputChars, d_scores, inputOffsets , inputLengths, d_selectedPositions, numSeq, d_overflow_positions, d_overflow_number, 1, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 26){call_NW_local_affine_single_pass_half2<sh2bs, 32, 26>(subMatrixType, inputChars, d_scores, inputOffsets , inputLengths, d_selectedPositions, numSeq, d_overflow_positions, d_overflow_number, 1, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 27){call_NW_local_affine_single_pass_half2<sh2bs, 32, 28>(subMatrixType, inputChars, d_scores, inputOffsets , inputLengths, d_selectedPositions, numSeq, d_overflow_positions, d_overflow_number, 1, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 28){call_NW_local_affine_single_pass_half2<sh2bs, 32, 30>(subMatrixType, inputChars, d_scores, inputOffsets , inputLengths, d_selectedPositions, numSeq, d_overflow_positions, d_overflow_number, 1, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 29){call_NW_local_affine_single_pass_half2<sh2bs, 32, 32>(subMatrixType, inputChars, d_scores, inputOffsets , inputLengths, d_selectedPositions, numSeq, d_overflow_positions, d_overflow_number, 1, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 30){call_NW_local_affine_single_pass_half2<sh2bs, 32, 34>(subMatrixType, inputChars, d_scores, inputOffsets , inputLengths, d_selectedPositions, numSeq, d_overflow_positions, d_overflow_number, 1, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 31){call_NW_local_affine_single_pass_half2<sh2bs, 32, 36>(subMatrixType, inputChars, d_scores, inputOffsets , inputLengths, d_selectedPositions, numSeq, d_overflow_positions, d_overflow_number, 1, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 32){call_NW_local_affine_single_pass_half2<sh2bs, 32, 38>(subMatrixType, inputChars, d_scores, inputOffsets , inputLengths, d_selectedPositions, numSeq, d_overflow_positions, d_overflow_number, 1, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 33){call_NW_local_affine_single_pass_half2<sh2bs, 32, 40>(subMatrixType, inputChars, d_scores, inputOffsets , inputLengths, d_selectedPositions, numSeq, d_overflow_positions, d_overflow_number, 1, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                
                                }else if(kernelTypeConfig.singlePassType == KernelType::DPXs16){
        
                                    constexpr int sh2bs = 256; // dpx s16 blocksize 
                                    if (partId == 0){call_NW_local_affine_single_pass_dpx_s16<sh2bs, 2, 24>(subMatrixType, inputChars, d_scores, inputOffsets , inputLengths, d_selectedPositions, numSeq, d_overflow_positions, d_overflow_number, 0, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 1){call_NW_local_affine_single_pass_dpx_s16<sh2bs, 4, 16>(subMatrixType, inputChars, d_scores, inputOffsets , inputLengths, d_selectedPositions, numSeq, d_overflow_positions, d_overflow_number, 0, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 2){call_NW_local_affine_single_pass_dpx_s16<sh2bs, 8, 10>(subMatrixType, inputChars, d_scores, inputOffsets , inputLengths, d_selectedPositions, numSeq, d_overflow_positions, d_overflow_number, 0, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 3){call_NW_local_affine_single_pass_dpx_s16<sh2bs, 8, 12>(subMatrixType, inputChars, d_scores, inputOffsets , inputLengths, d_selectedPositions, numSeq, d_overflow_positions, d_overflow_number, 0, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 4){call_NW_local_affine_single_pass_dpx_s16<sh2bs, 8, 14>(subMatrixType, inputChars, d_scores, inputOffsets , inputLengths, d_selectedPositions, numSeq, d_overflow_positions, d_overflow_number, 0, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 5){call_NW_local_affine_single_pass_dpx_s16<sh2bs, 8, 16>(subMatrixType, inputChars, d_scores, inputOffsets , inputLengths, d_selectedPositions, numSeq, d_overflow_positions, d_overflow_number, 0, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 6){call_NW_local_affine_single_pass_dpx_s16<sh2bs, 8, 18>(subMatrixType, inputChars, d_scores, inputOffsets , inputLengths, d_selectedPositions, numSeq, d_overflow_positions, d_overflow_number, 0, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 7){call_NW_local_affine_single_pass_dpx_s16<sh2bs, 8, 20>(subMatrixType, inputChars, d_scores, inputOffsets , inputLengths, d_selectedPositions, numSeq, d_overflow_positions, d_overflow_number, 0, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 8){call_NW_local_affine_single_pass_dpx_s16<sh2bs, 8, 22>(subMatrixType, inputChars, d_scores, inputOffsets , inputLengths, d_selectedPositions, numSeq, d_overflow_positions, d_overflow_number, 0, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 9){call_NW_local_affine_single_pass_dpx_s16<sh2bs, 8, 24>(subMatrixType, inputChars, d_scores, inputOffsets , inputLengths, d_selectedPositions, numSeq, d_overflow_positions, d_overflow_number, 0, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 10){call_NW_local_affine_single_pass_dpx_s16<sh2bs, 8, 26>(subMatrixType, inputChars, d_scores, inputOffsets , inputLengths, d_selectedPositions, numSeq, d_overflow_positions, d_overflow_number, 0, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 11){call_NW_local_affine_single_pass_dpx_s16<sh2bs, 8, 28>(subMatrixType, inputChars, d_scores, inputOffsets , inputLengths, d_selectedPositions, numSeq, d_overflow_positions, d_overflow_number, 0, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 12){call_NW_local_affine_single_pass_dpx_s16<sh2bs, 8, 30>(subMatrixType, inputChars, d_scores, inputOffsets , inputLengths, d_selectedPositions, numSeq, d_overflow_positions, d_overflow_number, 0, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 13){call_NW_local_affine_single_pass_dpx_s16<sh2bs, 8, 32>(subMatrixType, inputChars, d_scores, inputOffsets , inputLengths, d_selectedPositions, numSeq, d_overflow_positions, d_overflow_number, 1, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 14){call_NW_local_affine_single_pass_dpx_s16<sh2bs, 16, 18>(subMatrixType, inputChars, d_scores, inputOffsets , inputLengths, d_selectedPositions, numSeq, d_overflow_positions, d_overflow_number, 1, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 15){call_NW_local_affine_single_pass_dpx_s16<sh2bs, 16, 20>(subMatrixType, inputChars, d_scores, inputOffsets , inputLengths, d_selectedPositions, numSeq, d_overflow_positions, d_overflow_number, 1, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 16){call_NW_local_affine_single_pass_dpx_s16<sh2bs, 16, 22>(subMatrixType, inputChars, d_scores, inputOffsets , inputLengths, d_selectedPositions, numSeq, d_overflow_positions, d_overflow_number, 1, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 17){call_NW_local_affine_single_pass_dpx_s16<sh2bs, 16, 24>(subMatrixType, inputChars, d_scores, inputOffsets , inputLengths, d_selectedPositions, numSeq, d_overflow_positions, d_overflow_number, 1, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 18){call_NW_local_affine_single_pass_dpx_s16<sh2bs, 16, 26>(subMatrixType, inputChars, d_scores, inputOffsets , inputLengths, d_selectedPositions, numSeq, d_overflow_positions, d_overflow_number, 1, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 19){call_NW_local_affine_single_pass_dpx_s16<sh2bs, 16, 28>(subMatrixType, inputChars, d_scores, inputOffsets , inputLengths, d_selectedPositions, numSeq, d_overflow_positions, d_overflow_number, 1, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 20){call_NW_local_affine_single_pass_dpx_s16<sh2bs, 16, 30>(subMatrixType, inputChars, d_scores, inputOffsets , inputLengths, d_selectedPositions, numSeq, d_overflow_positions, d_overflow_number, 1, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 21){call_NW_local_affine_single_pass_dpx_s16<sh2bs, 16, 32>(subMatrixType, inputChars, d_scores, inputOffsets , inputLengths, d_selectedPositions, numSeq, d_overflow_positions, d_overflow_number, 1, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 22){call_NW_local_affine_single_pass_dpx_s16<sh2bs, 32, 18>(subMatrixType, inputChars, d_scores, inputOffsets , inputLengths, d_selectedPositions, numSeq, d_overflow_positions, d_overflow_number, 1, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 23){call_NW_local_affine_single_pass_dpx_s16<sh2bs, 32, 20>(subMatrixType, inputChars, d_scores, inputOffsets , inputLengths, d_selectedPositions, numSeq, d_overflow_positions, d_overflow_number, 1, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 24){call_NW_local_affine_single_pass_dpx_s16<sh2bs, 32, 22>(subMatrixType, inputChars, d_scores, inputOffsets , inputLengths, d_selectedPositions, numSeq, d_overflow_positions, d_overflow_number, 1, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 25){call_NW_local_affine_single_pass_dpx_s16<sh2bs, 32, 24>(subMatrixType, inputChars, d_scores, inputOffsets , inputLengths, d_selectedPositions, numSeq, d_overflow_positions, d_overflow_number, 1, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 26){call_NW_local_affine_single_pass_dpx_s16<sh2bs, 32, 26>(subMatrixType, inputChars, d_scores, inputOffsets , inputLengths, d_selectedPositions, numSeq, d_overflow_positions, d_overflow_number, 1, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 27){call_NW_local_affine_single_pass_dpx_s16<sh2bs, 32, 28>(subMatrixType, inputChars, d_scores, inputOffsets , inputLengths, d_selectedPositions, numSeq, d_overflow_positions, d_overflow_number, 1, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 28){call_NW_local_affine_single_pass_dpx_s16<sh2bs, 32, 30>(subMatrixType, inputChars, d_scores, inputOffsets , inputLengths, d_selectedPositions, numSeq, d_overflow_positions, d_overflow_number, 1, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 29){call_NW_local_affine_single_pass_dpx_s16<sh2bs, 32, 32>(subMatrixType, inputChars, d_scores, inputOffsets , inputLengths, d_selectedPositions, numSeq, d_overflow_positions, d_overflow_number, 1, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 30){call_NW_local_affine_single_pass_dpx_s16<sh2bs, 32, 34>(subMatrixType, inputChars, d_scores, inputOffsets , inputLengths, d_selectedPositions, numSeq, d_overflow_positions, d_overflow_number, 1, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 31){call_NW_local_affine_single_pass_dpx_s16<sh2bs, 32, 36>(subMatrixType, inputChars, d_scores, inputOffsets , inputLengths, d_selectedPositions, numSeq, d_overflow_positions, d_overflow_number, 1, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 32){call_NW_local_affine_single_pass_dpx_s16<sh2bs, 32, 38>(subMatrixType, inputChars, d_scores, inputOffsets , inputLengths, d_selectedPositions, numSeq, d_overflow_positions, d_overflow_number, 1, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 33){call_NW_local_affine_single_pass_dpx_s16<sh2bs, 32, 40>(subMatrixType, inputChars, d_scores, inputOffsets , inputLengths, d_selectedPositions, numSeq, d_overflow_positions, d_overflow_number, 1, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    ...
                                    if (partId == 0){ call_NW_local_affine_single_pass_float<2>(subMatrixType, inputChars, d_scores, inputOffsets, inputLengths, d_selectedPositions, numSeq, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 1){ call_NW_local_affine_single_pass_float<2>(subMatrixType, inputChars, d_scores, inputOffsets, inputLengths, d_selectedPositions, numSeq, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 2){ call_NW_local_affine_single_pass_float<4>(subMatrixType, inputChars, d_scores, inputOffsets, inputLengths, d_selectedPositions, numSeq, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 3){ call_NW_local_affine_single_pass_float<4>(subMatrixType, inputChars, d_scores, inputOffsets, inputLengths, d_selectedPositions, numSeq, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 4){ call_NW_local_affine_single_pass_float<4>(subMatrixType, inputChars, d_scores, inputOffsets, inputLengths, d_selectedPositions, numSeq, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 5){ call_NW_local_affine_single_pass_float<4>(subMatrixType, inputChars, d_scores, inputOffsets, inputLengths, d_selectedPositions, numSeq, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 6){ call_NW_local_affine_single_pass_float<6>(subMatrixType, inputChars, d_scores, inputOffsets, inputLengths, d_selectedPositions, numSeq, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 7){ call_NW_local_affine_single_pass_float<6>(subMatrixType, inputChars, d_scores, inputOffsets, inputLengths, d_selectedPositions, numSeq, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 8){ call_NW_local_affine_single_pass_float<6>(subMatrixType, inputChars, d_scores, inputOffsets, inputLengths, d_selectedPositions, numSeq, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 9){ call_NW_local_affine_single_pass_float<6>(subMatrixType, inputChars, d_scores, inputOffsets, inputLengths, d_selectedPositions, numSeq, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 10){ call_NW_local_affine_single_pass_float<8>(subMatrixType, inputChars, d_scores, inputOffsets, inputLengths, d_selectedPositions, numSeq, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 11){ call_NW_local_affine_single_pass_float<8>(subMatrixType, inputChars, d_scores, inputOffsets, inputLengths, d_selectedPositions, numSeq, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 12){ call_NW_local_affine_single_pass_float<8>(subMatrixType, inputChars, d_scores, inputOffsets, inputLengths, d_selectedPositions, numSeq, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 13){ call_NW_local_affine_single_pass_float<8>(subMatrixType, inputChars, d_scores, inputOffsets, inputLengths, d_selectedPositions, numSeq, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 14){ call_NW_local_affine_single_pass_float<10>(subMatrixType, inputChars, d_scores, inputOffsets, inputLengths, d_selectedPositions, numSeq, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 15){ call_NW_local_affine_single_pass_float<10>(subMatrixType, inputChars, d_scores, inputOffsets, inputLengths, d_selectedPositions, numSeq, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 16){ call_NW_local_affine_single_pass_float<12>(subMatrixType, inputChars, d_scores, inputOffsets, inputLengths, d_selectedPositions, numSeq, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 17){ call_NW_local_affine_single_pass_float<12>(subMatrixType, inputChars, d_scores, inputOffsets, inputLengths, d_selectedPositions, numSeq, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 18){ call_NW_local_affine_single_pass_float<14>(subMatrixType, inputChars, d_scores, inputOffsets, inputLengths, d_selectedPositions, numSeq, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 19){ call_NW_local_affine_single_pass_float<14>(subMatrixType, inputChars, d_scores, inputOffsets, inputLengths, d_selectedPositions, numSeq, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 20){ call_NW_local_affine_single_pass_float<16>(subMatrixType, inputChars, d_scores, inputOffsets, inputLengths, d_selectedPositions, numSeq, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 21){ call_NW_local_affine_single_pass_float<16>(subMatrixType, inputChars, d_scores, inputOffsets, inputLengths, d_selectedPositions, numSeq, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 22){ call_NW_local_affine_single_pass_float<18>(subMatrixType, inputChars, d_scores, inputOffsets, inputLengths, d_selectedPositions, numSeq, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 23){ call_NW_local_affine_single_pass_float<20>(subMatrixType, inputChars, d_scores, inputOffsets, inputLengths, d_selectedPositions, numSeq, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 24){ call_NW_local_affine_single_pass_float<22>(subMatrixType, inputChars, d_scores, inputOffsets, inputLengths, d_selectedPositions, numSeq, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 25){ call_NW_local_affine_single_pass_float<24>(subMatrixType, inputChars, d_scores, inputOffsets, inputLengths, d_selectedPositions, numSeq, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 26){ call_NW_local_affine_single_pass_float<26>(subMatrixType, inputChars, d_scores, inputOffsets, inputLengths, d_selectedPositions, numSeq, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 27){ call_NW_local_affine_single_pass_float<28>(subMatrixType, inputChars, d_scores, inputOffsets, inputLengths, d_selectedPositions, numSeq, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 28){ call_NW_local_affine_single_pass_float<30>(subMatrixType, inputChars, d_scores, inputOffsets, inputLengths, d_selectedPositions, numSeq, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 29){ call_NW_local_affine_single_pass_float<32>(subMatrixType, inputChars, d_scores, inputOffsets, inputLengths, d_selectedPositions, numSeq, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 30){ call_NW_local_affine_single_pass_float<34>(subMatrixType, inputChars, d_scores, inputOffsets, inputLengths, d_selectedPositions, numSeq, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 31){ call_NW_local_affine_single_pass_float<36>(subMatrixType, inputChars, d_scores, inputOffsets, inputLengths, d_selectedPositions, numSeq, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 32){ call_NW_local_affine_single_pass_float<38>(subMatrixType, inputChars, d_scores, inputOffsets, inputLengths, d_selectedPositions, numSeq, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 33){ call_NW_local_affine_single_pass_float<40>(subMatrixType, inputChars, d_scores, inputOffsets, inputLengths, d_selectedPositions, numSeq, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                
                                }else if(kernelTypeConfig.singlePassType == KernelType::DPXs32){
                                    //single pass ! must not use temp storage! allowed sequence length <= 32*numregs
                                    if (partId == 0){ call_NW_local_affine_single_pass_dpx_s32<2>(subMatrixType, inputChars, d_scores, inputOffsets, inputLengths, d_selectedPositions, numSeq, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 1){ call_NW_local_affine_single_pass_dpx_s32<2>(subMatrixType, inputChars, d_scores, inputOffsets, inputLengths, d_selectedPositions, numSeq, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 2){ call_NW_local_affine_single_pass_dpx_s32<4>(subMatrixType, inputChars, d_scores, inputOffsets, inputLengths, d_selectedPositions, numSeq, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 3){ call_NW_local_affine_single_pass_dpx_s32<4>(subMatrixType, inputChars, d_scores, inputOffsets, inputLengths, d_selectedPositions, numSeq, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 4){ call_NW_local_affine_single_pass_dpx_s32<4>(subMatrixType, inputChars, d_scores, inputOffsets, inputLengths, d_selectedPositions, numSeq, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 5){ call_NW_local_affine_single_pass_dpx_s32<4>(subMatrixType, inputChars, d_scores, inputOffsets, inputLengths, d_selectedPositions, numSeq, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 6){ call_NW_local_affine_single_pass_dpx_s32<6>(subMatrixType, inputChars, d_scores, inputOffsets, inputLengths, d_selectedPositions, numSeq, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 7){ call_NW_local_affine_single_pass_dpx_s32<6>(subMatrixType, inputChars, d_scores, inputOffsets, inputLengths, d_selectedPositions, numSeq, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 8){ call_NW_local_affine_single_pass_dpx_s32<6>(subMatrixType, inputChars, d_scores, inputOffsets, inputLengths, d_selectedPositions, numSeq, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 9){ call_NW_local_affine_single_pass_dpx_s32<6>(subMatrixType, inputChars, d_scores, inputOffsets, inputLengths, d_selectedPositions, numSeq, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 10){ call_NW_local_affine_single_pass_dpx_s32<8>(subMatrixType, inputChars, d_scores, inputOffsets, inputLengths, d_selectedPositions, numSeq, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 11){ call_NW_local_affine_single_pass_dpx_s32<8>(subMatrixType, inputChars, d_scores, inputOffsets, inputLengths, d_selectedPositions, numSeq, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 12){ call_NW_local_affine_single_pass_dpx_s32<8>(subMatrixType, inputChars, d_scores, inputOffsets, inputLengths, d_selectedPositions, numSeq, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 13){ call_NW_local_affine_single_pass_dpx_s32<8>(subMatrixType, inputChars, d_scores, inputOffsets, inputLengths, d_selectedPositions, numSeq, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 14){ call_NW_local_affine_single_pass_dpx_s32<10>(subMatrixType, inputChars, d_scores, inputOffsets, inputLengths, d_selectedPositions, numSeq, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 15){ call_NW_local_affine_single_pass_dpx_s32<10>(subMatrixType, inputChars, d_scores, inputOffsets, inputLengths, d_selectedPositions, numSeq, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 16){ call_NW_local_affine_single_pass_dpx_s32<12>(subMatrixType, inputChars, d_scores, inputOffsets, inputLengths, d_selectedPositions, numSeq, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 17){ call_NW_local_affine_single_pass_dpx_s32<12>(subMatrixType, inputChars, d_scores, inputOffsets, inputLengths, d_selectedPositions, numSeq, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 18){ call_NW_local_affine_single_pass_dpx_s32<14>(subMatrixType, inputChars, d_scores, inputOffsets, inputLengths, d_selectedPositions, numSeq, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 19){ call_NW_local_affine_single_pass_dpx_s32<14>(subMatrixType, inputChars, d_scores, inputOffsets, inputLengths, d_selectedPositions, numSeq, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 20){ call_NW_local_affine_single_pass_dpx_s32<16>(subMatrixType, inputChars, d_scores, inputOffsets, inputLengths, d_selectedPositions, numSeq, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 21){ call_NW_local_affine_single_pass_dpx_s32<16>(subMatrixType, inputChars, d_scores, inputOffsets, inputLengths, d_selectedPositions, numSeq, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 22){ call_NW_local_affine_single_pass_dpx_s32<18>(subMatrixType, inputChars, d_scores, inputOffsets, inputLengths, d_selectedPositions, numSeq, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 23){ call_NW_local_affine_single_pass_dpx_s32<20>(subMatrixType, inputChars, d_scores, inputOffsets, inputLengths, d_selectedPositions, numSeq, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 24){ call_NW_local_affine_single_pass_dpx_s32<22>(subMatrixType, inputChars, d_scores, inputOffsets, inputLengths, d_selectedPositions, numSeq, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 25){ call_NW_local_affine_single_pass_dpx_s32<24>(subMatrixType, inputChars, d_scores, inputOffsets, inputLengths, d_selectedPositions, numSeq, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 26){ call_NW_local_affine_single_pass_dpx_s32<26>(subMatrixType, inputChars, d_scores, inputOffsets, inputLengths, d_selectedPositions, numSeq, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 27){ call_NW_local_affine_single_pass_dpx_s32<28>(subMatrixType, inputChars, d_scores, inputOffsets, inputLengths, d_selectedPositions, numSeq, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 28){ call_NW_local_affine_single_pass_dpx_s32<30>(subMatrixType, inputChars, d_scores, inputOffsets, inputLengths, d_selectedPositions, numSeq, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 29){ call_NW_local_affine_single_pass_dpx_s32<32>(subMatrixType, inputChars, d_scores, inputOffsets, inputLengths, d_selectedPositions, numSeq, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 30){ call_NW_local_affine_single_pass_dpx_s32<34>(subMatrixType, inputChars, d_scores, inputOffsets, inputLengths, d_selectedPositions, numSeq, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 31){ call_NW_local_affine_single_pass_dpx_s32<36>(subMatrixType, inputChars, d_scores, inputOffsets, inputLengths, d_selectedPositions, numSeq, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 32){ call_NW_local_affine_single_pass_dpx_s32<38>(subMatrixType, inputChars, d_scores, inputOffsets, inputLengths, d_selectedPositions, numSeq, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 33){ call_NW_local_affine_single_pass_dpx_s32<40>(subMatrixType, inputChars, d_scores, inputOffsets, inputLengths, d_selectedPositions, numSeq, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
